          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mt-5 mb-3 line-clamp-2">
                  {project.title}
                </h3>
                ...
                <button
                  ...
                  className="mt-4 flex items-center gap-2 text-blue-600 font-semibold hover:gap-3 transition-all duration-300 group-hover:text-blue-700 self-start"
                >
                  View Case Study
