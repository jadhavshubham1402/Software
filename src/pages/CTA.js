        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-blue-100 mt-8 leading-8 text-lg">
              From custom software and AI solutions to enterprise
              applications, our experts help businesses build secure,
          ...
          <div className="bg-white rounded-3xl p-10 shadow-2xl">
            ...
            <p className="text-gray-600 mt-5 leading-7">
              ...
              the best technology and development approach.
            </p>
            ...
            <div className="flex flex-col gap-5 mt-10">
              ...
              <Link
                to="/contact"
                className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl py-4 px-6 flex justify-center items-center gap-3 transition"
              >
              ...
              <Link
                to="/portfolio"
                className="border border-blue-600 text-blue-600 hover:bg-blue-50 rounded-xl py-4 px-6 flex justify-center items-center gap-3 transition"
              >
                View Our Portfolio
              </Link>
