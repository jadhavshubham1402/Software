...
const industries = [
  {
    ...
    description:
      "World's Most Advanced Medical & Digital Health Technologies...",
  },
  {
    id: 2,
    icon: <FaUniversity />,
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {industries.map((industry, index) => (
            <motion.div
              ...
              className="group bg-white border border-gray-100 hover:border-blue-200 rounded-3xl p-8 transition-all duration-500 hover:shadow-xl flex flex-col h-full cursor-pointer"
            >
              ...
              <p className="text-gray-600 leading-relaxed flex-1 text-[12px]">
